#ifndef __FOXIT_FA_PDF_PASSWORD_H__
#define __FOXIT_FA_PDF_PASSWORD_H__
 ...
 */
int		FSADK_PDF_RemovePassword(char* outputPDFPath,char* inputPDFPath,char* inputPDFPassword=NULL);

#ifdef __cplusplus
};
#endif

#endif//__FOXIT_FA_PDF_PASSWORD_H__