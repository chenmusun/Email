 ...
 *							Range: from 0 to (charcount -1). <i>charcount</i> is returned by function ::FSPDF_TextPage_CountChars.
 * @param[out]	unicode		Pointer to a ::FS_DWORD object to receive the character's unicode.
 * 
 * @return		::FSCRT_ERRCODE_SUCCESS if succeeded.<br>
...
/**
 * @deprecated Current function will be deprecated in future. So, not recommend to use current function any more.
 *
