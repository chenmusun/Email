...
private:
	...
	map<long, CString> m_HelpData;
	CFThreadPool<MyJobParam*>*	m_pTestTheradPool;
...
public:
	...
	void GetMailBoxInfo(long lPos,CString& csInfo,MailBoxInfo& info);
	void GetDataBaseInfo(MongoDBInfo& dbinfo);
